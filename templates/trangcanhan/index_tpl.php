<div class="main-member">
        ...
        <p class="mtm strong"><?=_xinchao?> <?=$_SESSION["login"]["hoten"]?>  </p>
        ...
        <div class="line">
            ...
            <div class="frame-info">
                ...
                <div class="box-myaccount">
                    ...
                    <p class="ptm">
                        <?=$_SESSION["login"]["hoten"]?> <br>
                        <?=$_SESSION["login"]["email"]?>  - <a href="http://<?=$config_url?>/trang-ca-nhan/change-email/member" class="sel-link-change-email"><?=_thaydoidiachiemail?></a><br>
                    </p>
                    ...
                    <?php if ($item_user["tinh"]!="" and $item_user["huyen"]!="" and $item_user["diachi"]!="" ) {?>
                       <div class="address">
                                <p><?=$item_user["hotenkh"]?> <br><?=$item_user['diachi']?><br>
                                 ...
                                 <?=get_item_tinh($item_user['tinh'])?> - <?=get_item_quan($item_user['tinh'],$item_user['huyen'])?>
