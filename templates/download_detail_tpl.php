...
<div class="block_content">
    ...
    <div class="show-pro">
		...
		<div class="download-file"><a target="_blank" href="http://<?=$config_url?>/<?=_upload_download_l.$tintuc_detail[0]["file_download"]?>">Link DownLoad File</a></div>		
			
<iframe src="http://docs.google.com/gview?url=http://<?=$config_url?>/<?=_upload_download_l.$tintuc_detail[0]["file_download"]?>&embedded=true" style="width:900px; height:500px;" frameborder="0"></iframe>
