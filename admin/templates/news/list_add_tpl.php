...
<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
        	   ...
        	   <li><a href="index.php?com=news&act=man_list&typeparent=<?=$_GET['typeparent']?>"><span><?=$name_cap?></span></a></li>
...
<form name="supplier" id="validate" class="form" action="index.php?com=news&act=save_list&typeparent=<?=$_GET['typeparent']?>" method="post" enctype="multipart/form-data">
	<div class="widget">
     ...
     <div class="formRow">
			...
			<div class="formRight">
                   ...
                   <img src="<?php if($item['photo']!=NULL) echo _upload_news.$item['thumb']; else echo 'images/no_image.jpg';?>"  alt="NO PHOTO" style="max-width:300px;" />
                    <a class="delete_img_present" title="Xoá ảnh" onclick="Action_Delete_Img('index.php?com=news&act=save_list&typeparent=<?=$_GET['typeparent']?>&id=<?=@$item['id']?>&delete_img_present=delete_img');return false;" >Xoá ảnh</a>
                    <br>
                    <?php }?>
	...
	<input type="hidden" name="referer_link" id="id" value="index.php?com=news&act=man_list&typeparent=<?=$_GET['typeparent']?>" />
