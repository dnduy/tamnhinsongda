  ...
  <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
    ...
    <tbody>
       ...
       <input type="checkbox" name="chon[]" id="chon" value="<?=$items[$i]['id']?>" class="chon" />
        ...
        <td align="center">
            <input type="text" value="<?=$items[$i]['stt']?>" name="ordering[]" onkeypress="return OnlyNumber(event)" class="tipS smallText" original-title="Nhập số thứ tự" id="number<?=$items[$i]['id']?>" onchange="return updateNumber('news_list', '<?=$items[$i]['id']?>')" />
	 ...
	 <a href="index.php?com=news&act=man_list&menu_top=<?=$items[$i]['id']?>&typeparent=<?=@$_GET['typeparent']?>" title="" class="smallButton tipS" original-title="Click để ẩn"><img src="./images/icons/color/tick.png" alt=""></a>
		...
		{
		?>
           <a href="index.php?com=news&act=man_list&menu_top=<?=$items[$i]['id']?>&typeparent=<?=@$_GET['typeparent']?>" title="" class="smallButton tipS" original-title="Click để hiện"><img src="./images/icons/color/hide.png" alt=""></a>
       <?php }
        ?>     
	 ...
	 <a href="index.php?com=news&act=man_list&nhom_tin=<?=$items[$i]['id']?>&typeparent=<?=@$_GET['typeparent']?>" title="" class="smallButton tipS" original-title="Click để ẩn"><img src="./images/icons/color/tick.png" alt=""></a>
		...
		{
		?>
           <a href="index.php?com=news&act=man_list&nhom_tin=<?=$items[$i]['id']?>&typeparent=<?=@$_GET['typeparent']?>" title="" class="smallButton tipS" original-title="Click để hiện"><img src="./images/icons/color/hide.png" alt=""></a>
       <?php }
        ?>     
		...
		?>
            ...
            <?php } else { ?>
         <a href="index.php?com=news&act=man_list&typeparent=<?=$_GET['typeparent']?>&hienthi=<?=$items[$i]['id']?>" title="" class="smallButton tipS" original-title="Click để hiện"><img src="./images/icons/color/hide.png" alt=""></a>
         <?php } ?>
        </td>
        
        <td class="actBtns">
            <a href="index.php?com=news&act=edit_list&typeparent=<?=$_GET['typeparent']?>&id=<?=$items[$i]['id']?>" title="" class="smallButton tipS" original-title="Sửa sản phẩm"><img src="./images/icons/dark/pencil.png" alt=""></a>
            <a href="index.php?com=news&act=delete_list&typeparent=<?=$_GET['typeparent']?>&id=<?=$items[$i]['id']?>" onclick="CheckDelete('index.php?com=news&act=delete_list&typeparent=<?=$_GET['typeparent']?>&id=<?=$items[$i]['id']?>'); return false;" title="" class="smallButton tipS" original-title="Xóa sản phẩm"><img src="./images/icons/dark/close.png" alt=""></a>        </td>
      </tr>
         <?php } ?>
                </tbody>
