  ...
  <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
    ...
    <tbody>
       ...
       <td>
        ...
        <td align="center">
            <input type="text" style="width:15%" value="<?=$items[$i]['stt']?>" name="ordering[]" onkeypress="return OnlyNumber(event)" class="tipS smallText" original-title="Nhập số thứ tự sản phẩm" id="number<?=$items[$i]['id']?>" onchange="return updateNumber('newsletter', '<?=$items[$i]['id']?>')" />
          ...
          <td>
         <a href="index.php?com=newsletter&act=edit&id=<?=$items[$i]['id']?>" class="tipS SC_bold"><?=$items[$i]['dienthoai']?></a>
        </td>
 ...
 <input type="text" name="FullName" title="Nhập tên" id="FullName" class="tipS validate[required]"  />
        ...
        <div class="formRow">
			...
			<div class="formRight">
             ...
             <input type="file"  name="file" /><img src="./images/question-button.png" alt="Upload hình" class="icon_question tipS" original-title="Tải hình đại diện cho sản phẩm (ảnh JPEG, GIF , JPG , PNG)">  <?=$kichthuoc?>
